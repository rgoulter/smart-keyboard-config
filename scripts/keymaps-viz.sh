#!/usr/bin/env bash
# Render keymap diagrams (docs/keymaps/layouts/*) into
...
#
# Needs KEYMAP_VIZ_ROOT (tools/keymap-viz-rhombus in a smart-keymap
# checkout) plus racket/nickel/inkscape on PATH. SMART_KEYMAP_ROOT defaults
# to the smart-keymap checkout root derived from KEYMAP_VIZ_ROOT.
set -euo pipefail
...
viz="${KEYMAP_VIZ_ROOT:?set KEYMAP_VIZ_ROOT to tools/keymap-viz-rhombus in a smart-keymap checkout}"
